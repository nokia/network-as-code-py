# location-client
Location can verify if the specified user is within the given area
...
## Documentation For Models
 ...
 - [CivicAddress](docs/models/CivicAddress.md)
...
If the OpenAPI document is large, imports in location_client.apis and location_client.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from location_client.apis.default_api import DefaultApi`
...
import location_client
from location_client.apis import *
from location_client.models import *
```
