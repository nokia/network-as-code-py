...
SchemaFor200ResponseBodyApplicationJson = EventSubscriptionInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_event_subscription_oapg(
        self,
...
class GetEventSubscription(BaseApi):
    ...
    def get_event_subscription(
        ...
        return self._get_event_subscription_oapg(
