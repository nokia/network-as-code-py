...
class EventSubscriptionDetail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eventType", "device", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eventType", "device", ], str]):
