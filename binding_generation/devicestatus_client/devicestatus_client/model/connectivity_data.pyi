...
class ConnectivityData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            maxNumOfReports = schemas.IntSchema
            __annotations__ = {
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "maxNumOfReports", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["maxNumOfReports"]) -> typing.Union[MetaOapg.properties.maxNumOfReports, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "maxNumOfReports", ], str]):
