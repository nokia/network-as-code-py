# devicestatus_client.model.create_event_subscription.CreateEventSubscription
...
**maxNumberOfReports** | decimal.Decimal, int,  | decimal.Decimal,  | Number of notifications until the subscription is available | [optional] if omitted the server will use the default value of 1
