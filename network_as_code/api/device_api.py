...
class DeviceAPI:
    ...
    def create_session(self, sid: Union[None, any] = None, ipv4_address, phone_number, profile, service_ipv4, service_ipv6 = None, device_ports: Union[None, any] = None, service_ports: Union[None, any] = None, duration = None, notification_url = None, notification_auth_token = None):
