...
class ServicesAPI:
    def get_all_services(self) -> list:
        res: Response = self._get("/services")
        return self._result(res, json=True)

    def get_service(self, service_id: str) -> dict:
        res: Response = self._get(f"/services/{service_id}")
        return self._result(res, json=True)

    def get_slice(self, service_id: str, slice_id: str) -> dict:
        """"""
        # TODO: Input validation
        res: Response = self._get(f"/services/{service_id}/slices/{slice_id}")
        return self._result(res, json=True)
    ...
    def delete_slice(self, service_id, slice_id) -> bool:
        res: Response = self._delete(f"/services/{service_id}/slices/{slice_id}")
